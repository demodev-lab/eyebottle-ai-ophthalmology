...
export default function NewCartoonPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-3xl font-bold text-slate-800">새 만화 등록</h1>
          <p className="text-base text-slate-600 mt-1">안과 교육용 만화를 등록하세요</p>
        </div>
        <Link
          href="/cartoons/admin"
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <Card className="border-0 shadow-xl bg-white">
          ...
          <CardContent className="space-y-4 p-6">
            ...
            <div className="flex items-center space-x-3 p-4 bg-slate-50 rounded-lg">
              ...
              />
              <Label htmlFor="isPublished" className="text-base font-medium text-slate-700 cursor-pointer">즉시 게시</Label>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="border-0 shadow-xl bg-white">
          <CardHeader className="border-b bg-gradient-to-r from-slate-50 to-gray-50">
            <CardTitle className="text-xl font-semibold text-slate-800">이미지 업로드 * (최대 10개)</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4 p-6">
            {/* 업로드 버튼 */}
            <div>
