...
interface HypertensionPreviewProps {
  data: HypertensionData
}

export function HypertensionPreview({ data }: HypertensionPreviewProps) {
  return (
    <div className="bg-white p-6 rounded-lg shadow-md">
      ...
      {/* 미리보기 내용 */}
      <div id="hypertension-preview" className="space-y-6">
        {/* 제목 */}
        <div className="text-center border-b pb-4">
          <h1 className="text-2xl font-bold text-gray-800">고혈압망막병증 검진 결과서</h1>
        </div>
        ...
        <section className="bg-yellow-50 border border-yellow-200 rounded-lg p-5">
          ...
          <div className="space-y-2">
            ...
            {data.summary.bloodPressureTarget && (
              <div className="mt-3">
                <p className="font-medium text-gray-800">목표 혈압:</p>
                <p className="text-gray-700">{data.summary.bloodPressureTarget} mmHg 이하</p>
              </div>
            )}
            <div className="mt-3">
